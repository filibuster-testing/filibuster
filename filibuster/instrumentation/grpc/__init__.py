...
from opentelemetry import trace
from filibuster.instrumentation.grpc.grpcext import intercept_channel
from filibuster.instrumentation.grpc.version import __version__
...
from filibuster.logger import notice, debug
...
class GrpcInstrumentorServer(BaseInstrumentor):
    ...
    def _instrument(self, **kwargs):
        ...
        _filibuster_global_context_set_value("filibuster_service_name", kwargs['service_name'])
        _filibuster_global_context_set_value("filibuster_url", kwargs['filibuster_url'])
